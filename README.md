...
**_Note:_** *As of version 1.6.0 Svelte components have to be version 3 components. If you need support for Svelte 2.x you have to use version 1.5.1 and below*
